...
typedef struct
{
    ...
    float       fuel_consumption; /* average fuel consumption */
    float       fuel_prev; /* average fuel consumption */
    float       fuel_time; /* average fuel consumption */
